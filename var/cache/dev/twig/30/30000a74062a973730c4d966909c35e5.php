...
class __TwigTemplate_c76ba9ec05cf85a3f80e7cb6ecfee1ef extends Template
{
    private $source;
    private $macros = [];
    ...
    <form class=\"form\" method=\"post\">
        ...
        // line 11
        echo "        <div class=\"loginForm--flex\">
            <div class=\"loginForm__img\">
                <img src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("build/images/connexion.jpg"), "html", null, true);
        echo "\" alt=\"img connexion\">
            </div>
...
";
    ...
    {
        return array (  128 => 28,  120 => 23,  112 => 18,  104 => 13,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"loginForm\">
    <form class=\"form\" method=\"post\">
        ...
        <div class=\"loginForm--flex\">
            <div class=\"loginForm__img\">
                <img src=\"{{ asset('build/images/connexion.jpg') }}\" alt=\"img connexion\">
            </div>
            <div class=\"loginForm__form\">
                <h1>Se connecter</h1>
                <label for=\"inputEmail\">Email :</label>
                ...
                <a href=\"{{ path('app_forgot_password_request')}}\" class=\"myButton\" >
                    Mot de passe oublié
                </a>
           </div>
        </div>
...
{% endblock %}
", "security/connexion.html.twig", "/var/www/html/foodtruck/templates/security/connexion.html.twig");
    }
}
