...
class __TwigTemplate_f17820bf152fecaf70b96945332dba5f extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["attribute"]) || array_key_exists("attribute", $context) ? $context["attribute"] : (function () { throw new RuntimeError('Variable "attribute" does not exist.', 327, $this->source); })()), "type", [], "any", false, false, false, 327) == "string")) {
                ...
                echo "                        </td>
                        <td>";
                // line 336
                echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "seek", ["object"], "method", false, false, false, 336));
                echo "</td>
                    </tr>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/var/www/html/foodtruck/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
