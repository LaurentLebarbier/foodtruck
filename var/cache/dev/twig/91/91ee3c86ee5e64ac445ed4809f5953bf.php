...
class __TwigTemplate_0fd186ee95979401fe325e0f9af7fc91 extends Template
{
    private $source;
    private $macros = [];
...
<form class=\"form\" method=\"post\">
    Un e-mail vient d'être envoyé contenant un lien que vous pouvez utiliser pour réinitialiser votre mot de passe. 
    ...
    Si vous ne recevez pas d'e-mail, veuillez vérifier votre dossier spam ou <a href=\"";
        ...
        echo "\" class=\"myButton\" >Réessayer</a>
</form>
</div>
";
...
<form class=\"form\" method=\"post\">
    ...
    Si vous ne recevez pas d'e-mail, veuillez vérifier votre dossier spam ou <a href=\"{{ path('app_forgot_password_request') }}\" class=\"myButton\" >Réessayer</a>
</form>
</div>
{% endblock %}
", "reset_password/check_email.html.twig", "/var/www/html/foodtruck/templates/reset_password/check_email.html.twig");
    }
}
