...
class __TwigTemplate_5a011a5e165805d3f9d831f6669185b3216645db0aabe5a1a9f618844d7ce70e extends Template
{
    private $source;
    private $macros = [];
...
<p>Pour réinitialiser votre mot de passe, veuillez cliqué sur lien suivant</p>
...
<a href=\"{{ url('app_reset_password', {token: resetToken.token}) }}\">LIEN</a>

<p>Ce lien expirera dans {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, 'ResetPasswordBundle') }}.</p>

<p>Merci</p>
", "reset_password/email.html.twig", "/var/www/html/foodtruck/templates/reset_password/email.html.twig");
    }
}
