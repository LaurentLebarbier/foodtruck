...
class __TwigTemplate_0fce3176d207b960a35fe191e48670ad extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 86, $this->source); })()), "query", [], "any", false, false, false, 86), "get", ["connection"], "method", false, false, false, 86), "query" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,             // line 87
...
{% endmacro %}
", "@Doctrine/Collector/db.html.twig", "/var/www/html/foodtruck/vendor/doctrine/doctrine-bundle/Resources/views/Collector/db.html.twig");
    }
}
