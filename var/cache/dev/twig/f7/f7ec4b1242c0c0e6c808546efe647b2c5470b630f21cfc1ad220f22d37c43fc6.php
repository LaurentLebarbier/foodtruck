...
class __TwigTemplate_6d954f4eabaeabcea5959d27bb9143295a1180fbf9741250a7e912dccf834d4d extends Template
{
    private $source;
    private $macros = [];
        ...
        <table>
            ...
            echo "            </tbody>
             ...
             <tr>
                ...
                <td>";
            // line 29
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 29, $this->source); })()), "price", [], "any", false, false, false, 29), "html", null, true);
            echo "</td>
             <tr>
...
";
    ...
    {
        return array (  169 => 41,  159 => 40,  147 => 36,  137 => 29,  130 => 24,  121 => 21,  117 => 20,  113 => 19,  110 => 18,  106 => 17,  92 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
