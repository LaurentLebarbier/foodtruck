...
class __TwigTemplate_e866d87ad094b8bd06f1bf162b6ffe23065f056a201613720b50e320b792a51a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        if ((array_key_exists("order", $context) &&  !(null === (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 6, $this->source); })())))) {
            // line 7
        ...
        <table>
            ...
            echo "            </tbody>
             ...
             <tr>
                 ...
                 <td>";
            // line 28
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 28, $this->source); })()), "price", [], "any", false, false, false, 28), "html", null, true);
            echo "</td>
             <tr>
...
";
    ...
    {
        return array (  168 => 40,  158 => 39,  146 => 35,  136 => 28,  130 => 24,  121 => 21,  117 => 20,  113 => 19,  110 => 18,  106 => 17,  92 => 7,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
    ...
    {% if order is defined and order is not null  %}
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <th>{{ produit.produit.name }}</th>
                    <th>{{ produit.quantite }}</th>
                    <th>{{ produit.produit.prix }}</th>
                </tr>
                {% endfor %}
            </tbody>
             <tfoot>
...
{% endblock %}", "order/index.html.twig", "/var/www/html/foodtruck/templates/order/index.html.twig");
    }
}
