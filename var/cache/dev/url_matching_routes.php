...
return [
    ...
    [ // $staticRoutes
        ...
        '/admin/order' => [[['_route' => 'admin_cart_index', '_controller' => 'App\\Controller\\Admin\\AdminCartController::index'], null, null, null, true, false, null]],
        '/admin/order/wait' => [[['_route' => 'admin_cart_wait', '_controller' => 'App\\Controller\\Admin\\AdminCartController::ordersWait'], null, null, null, true, false, null]],
        '/admin/order/past' => [[['_route' => 'admin_cart_past', '_controller' => 'App\\Controller\\Admin\\AdminCartController::odersPast'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        211 => [[['_route' => 'admin_modifier_utilisateurs', '_controller' => 'App\\Controller\\Admin\\AdminController::editUser'], ['id'], null, null, false, true, null]],
        234 => [[['_route' => 'admin_supprimer_utilisateurs', '_controller' => 'App\\Controller\\Admin\\AdminController::delete'], ['id'], null, null, false, true, null]],
        266 => [[['_route' => 'admin_option_edit', '_controller' => 'App\\Controller\\Admin\\AdminOptionController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        280 => [[['_route' => 'admin_option_delete', '_controller' => 'App\\Controller\\Admin\\AdminOptionController::delete'], ['id'], null, null, false, false, null]],
        309 => [[['_route' => 'admin_produits_edit', '_controller' => 'App\\Controller\\Admin\\AdminProduitsController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        332 => [[['_route' => 'admin_produits_delete', '_controller' => 'App\\Controller\\Admin\\AdminProduitsController::delete'], ['id'], null, null, false, true, null]],
        375 => [[['_route' => 'produit_show', '_controller' => 'App\\Controller\\ProduitController::show'], ['slug', 'id'], null, null, false, true, null]],
        419 => [
