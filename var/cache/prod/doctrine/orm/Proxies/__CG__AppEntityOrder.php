...
class Order extends \App\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function setPrice(string $price): \App\Entity\Order
    {
     ...
     * {@inheritDoc}
     */
    public function getOrderProduits(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrderProduits', []);

        return parent::getOrderProduits();
    }

    /**
     * {@inheritDoc}
     */
    public function addOrderProduit(\App\Entity\OrderProduits $orderProduit): \App\Entity\Order
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOrderProduit', [$orderProduit]);

        return parent::addOrderProduit($orderProduit);
    }

    /**
     * {@inheritDoc}
     */
    public function removeOrderProduit(\App\Entity\OrderProduits $orderProduit): \App\Entity\Order
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeOrderProduit', [$orderProduit]);

        return parent::removeOrderProduit($orderProduit);
    }
