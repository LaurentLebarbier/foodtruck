 ...
 */
final class Version20211011133923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398CD11A2CF FOREIGN KEY (produits_id) REFERENCES produits (id)');
